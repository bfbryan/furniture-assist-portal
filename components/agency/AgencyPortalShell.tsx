      ...
      >
        ...
        <nav style={{ flex: 1, padding: '12px 12px 16px', display: 'flex', flexDirection: 'column', gap: '2px', overflowY: 'auto' }}>
          ...
          {/* Profile, Team and Help sit outside the REFERRALS group. This 18px
              ...
              label — the same job the section header does at its top. */}
          ...
          {/* Every staff member needs this regardless of role, so it isn't
              admin-gated like Team above. No Client Guidelines page exists
              yet to group this with (see agency-help-page branch writeup) —
              stands alone for now. */}
          <Link href="/help" style={linkStyle(isActive('/help'))}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
