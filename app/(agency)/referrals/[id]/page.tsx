      ...
      <header className="fa-detail-header" style={{ background: 'white', borderBottom: '1px solid #EDE9E1', padding: '18px 32px' }}>
        ...
        <div className="fa-detail-header-actions" style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
          ...
          {isCancellable && !awaitingOutcome && (
            <HeaderButton tier="danger" onClick={() => setConfirmModal({ open: true, type: 'cancel', id: referral.id, name: referral.clientName, date: referral.appointmentDate, time: referral.appointmentTime })}>
              Cancel
            </HeaderButton>
          )}
          {isWithdrawable && (
